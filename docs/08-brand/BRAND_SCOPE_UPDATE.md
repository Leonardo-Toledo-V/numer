...
## T-BRAND-015 · Afinar la identidad para varias cuentas y tarjetas

- Estado: terminada como elaboración y registro de marca; propuestas editoriales pendientes de revisión.
- Responsable: brand-strategist. Revisor: usuario.
- Objetivo observable: reflejar el alcance expresado sin reducir Numer a una tarjeta y preparar una entrega de marca coherente.
- Entradas: BR-C26 a BR-C29; [contexto](../00-project/PROJECT_CONTEXT.md), [estado](../00-project/STATUS.md), [rol](../../agents/brand-strategist.md), [guía](BRAND_GUIDELINES.md), [voz](BRAND_VOICE.md) y activos 0.1.
- Propiedad: únicamente `docs/08-brand/`; documentación de guía, voz, índice y handoff. No se modifica el sitio publicado ni archivos de otros roles.
- Exclusiones: producto, backend, frontend, especificación técnica, selección de librería, cálculos, custodia y despliegue.
- Dependencias: decisiones financieras y técnicas de otros roles pendientes; no bloquean el trabajo editorial.
- Criterios de aceptación: instrucciones registradas con procedencia, mensajes para varias cuentas/tarjetas, exclusiones de datos explícitas, diferencia dinero/crédito/deuda, preferencia de animación preservada. Cumplidos en documentación.
- Validación: revisión de consistencia editorial y enlaces; sin pruebas de producto ni afirmaciones de seguridad implementada.
- Decisiones pendientes: BR-P11 a BR-P13, BR-M01, textos nuevos y reglas ampliadas de uso; revisión creativa del usuario y posterior aplicación por UX/UI.
- Entregables: este registro, guía 0.2 y voz 0.2, índice y handoff actualizados.

## Handoff · T-BRAND-015

- Fecha y destinatarios: 2026-09-15; usuario para revisar marca; orquestador y UX/UI mediante documentos locales.
- Resultado: requisitos expresados conservados como confirmados; posicionamiento, vocabulario, mensajes y movimiento elaborados como propuestas. Identidad gráfica elegida conservada.
- Archivos: `BRAND_SCOPE_UPDATE.md`, `BRAND_GUIDELINES.md`, `BRAND_VOICE.md`, `BRAND_HANDOFF.md`, `README.md`.
- Verificación y límites: coherencia documental y enlaces. Sin implementación, validación de cálculos, QA de seguridad o actualización de Sites.
- Siguiente responsable: brand-strategist incorpora comentarios y cierra la guía de marca. Los demás roles incorporan únicamente las decisiones pertinentes cuando reciban su encargo; este handoff no inicia trabajo fuera de branding.
