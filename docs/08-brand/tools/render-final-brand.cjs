...
const r=require;
const root=path.resolve(__dirname,'..'),kit=path.join(root,'deliverables/numer-brand-kit-v1.0'),out=path.join(root,'assets/brand-final');
(async()=>{
 ...
 await page.setContent('<style>html,body{margin:0;background:#F5F6F7}body{display:flex;align-items:center;justify-content:center;width:960px;height:320px}img{width:630px;height:auto}</style><img alt="Numer, logotipo original con corte diagonal" src="data:image/svg+xml;base64,'+mark+'">');
