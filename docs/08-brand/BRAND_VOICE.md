...
Fecha: 2026-09-15. Responsable: brand-strategist. Estado: **voz aceptada mediante BR-A07** como parte del resto de la entrega RC1; no aplicada al sitio ni a una aplicación. Los apartados de tarea conservan el estado histórico de su entrega.

## Encargo y alcance

BR-C24 confirma continuar con la voz: «Continuemos con voz». La referencia creativa conserva la claridad y el cuidado de Apple, con una expresión propia para Numer. Los principios y mensajes cuentan con el visto bueno BR-A07, posterior a su propuesta inicial. Desarrollan el antecedente BR-P09 sin aprobar automáticamente su eslogan.

La edición 0.2 incorpora la instrucción de varias cuentas/tarjetas y registro sin datos identificativos de tarjeta, BR-C26 a BR-C29, con procedencia y límites en [alcance de marca](BRAND_SCOPE_UPDATE.md). La respuesta posterior «de ahí todo bien» acepta la entrega de marca (BR-A07), sin aprobar funciones o estados todavía sin especificar.
...
## T-BRAND-014 · Voz y criterio de redondeado

- Estado: terminada como propuesta editorial; pendiente de revisión del usuario.
- Responsable: brand-strategist. Revisor: usuario. Destinatario posterior: UX/UI.
- Objetivo observable: presentar una voz de Numer mediante principios y mensajes concretos, y resolver la duda sobre redondeado de Apple.
- Entradas: BR-C24 y BR-C25; [contexto](../00-project/PROJECT_CONTEXT.md), [estado](../00-project/STATUS.md), [rol](../../agents/brand-strategist.md), [guía](BRAND_GUIDELINES.md), [handoff](BRAND_HANDOFF.md), [reglas](../01-product/BUSINESS_RULES.md), [navegación](NAVIGATION_MOVEMENTS.md) y fuente oficial de Apple enlazada allí.
- Propiedad y alcance: documentos de `docs/08-brand/`. No se modifica el adjunto publicado, el Site, la aplicación ni documentos de otros roles.
- Exclusiones: aprobación unilateral de voz, nuevas funciones, rediseño, publicación de cambios y especificación de reglas financieras.
- Dependencias: estados y operaciones definitivos de producto pendientes; no impiden comparar la propuesta de voz.
- Criterios de aceptación: voz concreta, ejemplos de bienvenida/confirmación/error/aviso, condiciones de veracidad visibles y respuesta sustentada sobre Apple. Cumplidos como propuesta.
- Validación: revisión editorial de los 16 ejemplos, distinción registro/ejecución y éxito/error/resultado incierto; enlaces locales comprobados. Fuente oficial consultada el 2026-09-15. Sin pruebas de comprensión con usuarios ni integración.
- Decisiones pendientes: usuario valida la voz; UX/UI ajusta microcopy a los recorridos y retoma el estado activo del sidebar cuando corresponda.
- Entregables: este documento, actualización de navegación, guía, índice y handoff.

## Handoff · T-BRAND-014

- Fecha y responsables: 2026-09-15; brand-strategist → usuario para revisión, UX/UI mediante documento local.
- Resultado: BR-V01 a BR-V05 propuestos; BR-C24 y BR-C25 confirmados como encargos. Sin nuevas aprobaciones creativas.
- Archivos: `BRAND_VOICE.md`, `NAVIGATION_MOVEMENTS.md`, `BRAND_GUIDELINES.md`, `BRAND_HANDOFF.md` y `README.md`.
- Verificación: revisión editorial y referencia oficial de Apple. No se editaron ni desplegaron interfaces.
- Riesgos y límites: mensajes condicionados requieren datos y estados reales antes de uso; no confundir propuestas editoriales con funciones disponibles.
- Siguiente acción: usuario revisa el carácter verbal y los ejemplos; brand-strategist incorpora comentarios y UX/UI los vincula a estados especificados.
